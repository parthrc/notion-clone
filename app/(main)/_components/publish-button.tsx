...
export default function PublishButton({ initialData }: PublishButtonProps) {
  ...
  const onPublish = () => {
    ...
    toast.promise(promise, {
      loading: "Publishing...",
      success: "Doc published successfully",
  ...
  const onUnpublish = () => {
    ...
    toast.promise(promise, {
      ...
      success: "Doc unpublished successfully",
      ...
      <PopoverTrigger asChild>
        <Button size="sm" variant="ghost">
          ...
          {initialData.isPublished && (
            <Globe className="text-sky-500 2-4 h-4 ml-2" />
          )}
        </Button>
      </PopoverTrigger>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-x-2">
              ...
              <p className="text-xs font-medium text-sky-50">
                This page is published on the web
              </p>
            </div>
